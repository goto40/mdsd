 ...
 * starts `tshark`
   * with the generated lua dissectors ([multimessage.dissector](model/multimessage.dissector) and [model/polygon.dissector](model/polygon.dissector): `-X lua_script:src-gen/lua/multimessage.lua -X lua_script:src-gen/lua/polygon.lua`
