...
from item_codegen_lua.common import (
...
def generate_lua_for_constants(constants_obj, output_file, overwrite):
    pass
    # if not exists(output_file) or (
    #     overwrite and obj_is_newer_than_file(constants_obj, output_file)
    # ):
    #     with open(output_file, "w") as f:
    #         f.write(
    #             "#ifndef __{}_{}_H\n".format(
    #                 "_".join(get_package_names_of_obj(constants_obj)),
    #                 constants_obj.name.upper(),
    #             )
    #         )
    #         f.write(
    #             "#define __{}_{}_H\n".format(
    ...
    #         generate_lua_constants(f, constants_obj)
...
# def generate_lua_constants(f, cs):
